...
import main.java.interfaces.ILoanDAO;
...
public class LoanDAO implements ILoanDAO {
    public void save(Loan loan) {
        ...
        try {
            ...
            System.out.println(String.format("Error saving loan: %s", e.getMessage()));
    ...
    public void saveAll(List<Loan> loans) {
        ...
        try {
            ...
            for (int i = 0; i < loans.size(); i++) {
                em.persist(loans.get(i));
                if (i % 50 == 0) { // Ogni 50 operazioni, si esegue il flush per evitare troppa memoria
                    em.flush();
                    em.clear();
                }
            }
            ...
            System.out.println("Error saving all loans");
            System.out.println(e.getMessage());
        } finally {
            em.close();
        }
